  ...
  return function o(s, u, i) {
    function c(t, e) {
      ...
      var b = e("github-calendar-parser"),
        ...
        p = m(p), (g = g || {}).summary_text = g.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", g.cache = 1e3 * (g.cache || 86400), !1 === g.global_stats && (true);var r = "gh_calendar_content",
